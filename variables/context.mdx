...
El contexto sirve para guardar variables que persisten únicamente durante la ejecución actual, es decir, solo viven dentro del flujo específico donde se crean. Si necesitas guardar datos que duren hasta 24 horas, te recomendamos utilizar la <a href="/variables/memory">Memoria</a>.
